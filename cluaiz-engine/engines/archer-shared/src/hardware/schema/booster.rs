...
#[archive(check_bytes)]
pub struct SiliconBooster {
    pub max_power_limit_watts: Option<u32>,
    pub max_clock_mhz: Option<u32>,
    pub fan_curve_boost: bool,
    pub performance_profile: String, // "Turbo", "Balanced", "Eco"
}
...
impl Default for BoosterControl {
    fn default() -> Self {
        Self {
            ...
            silicon: SiliconBooster::default(),
        }
    }
}
