...
The `scratch/` directory is an isolated, strictly temporary testing environment for the Cluaize Inference Engine. It is explicitly designed for engineers to write, execute, and profile small snippets of Rust code without polluting the primary workspace or affecting the compilation of the core `engines` crate.
