...
The `handlers/` directory is the edge layer of the Cluaize inference engine. When external clients (Desktop UIs, Web Dashboards, or OpenAI-compatible scripts) send HTTP REST requests, those requests land here. 
