...
/// CluaizeInference: The advanced streaming iteration interface.
pub trait CluaizeInference: Send + Sync + UnifiedBackend {
    ...
    fn inject_signals(&mut self, _signals: Vec<crate::hardware::memory::kv_cache::stitching::CluaizeSignal>) -> Result<()> {
...
pub type ModelWeightsWrapper = Box<dyn CluaizeInference + Send + Sync>;
