...
/// 🧪 CluaizeSignal: A pack of pre-encoded neural states (Frozen History).
#[derive(Clone)]
pub struct CluaizeSignal {
...
pub trait NeuralStitcher {
    fn inject_signal(&mut self, signal: CluaizeSignal) -> Result<()>;
}
