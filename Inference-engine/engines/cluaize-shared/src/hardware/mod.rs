...
/// 🧬 Cluaize Bridge: Alias for get_sovereign_profile() for naming-migration compat.
pub fn get_Cluaize_profile() -> schema::profiles::CluaizeProfile {
    get_sovereign_profile()
}

impl schema::profiles::SovereignProfile {
    /// 🧬 Cluaize Bridge: Alias for to_silicon_truth() for naming-migration compat.
