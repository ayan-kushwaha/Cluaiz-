...
impl SlotType {
    ...
    pub fn detect_from_metadata(
        ...
        if has_vision || arch_lower.contains("qwen2vl") || arch_lower.contains("llava") || arch_lower.contains("phi3v") {
            caps.has_vision = true;
            caps.is_instruct = true; // Multimodal models are instruct aligned
