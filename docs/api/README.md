...
### 1. [Inference & Multimodal Execution](./inference/chat_completions.md)
...
### 2. [Model Management](./models/list_models.md)
...
### 3. [System & Hardware Telemetry](./system/info_health.md)
...
* **[`POST /engine/skip_think` & `POST /engine/cancel`](./system/stream_control.md)** — Real-time live stream steering (Skip thinking block / Abort active generation).
