...
Cluaize operates as a universal neural kernel, enforcing compile-time validation for a diverse matrix of processors, backends, and operating systems.
...
### 1. Baseline CPU Kernels (`cluaize-kernel`)
...
### 2. Accelerator Drivers (`cluaize-driver`)
